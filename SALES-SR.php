...
<head>
  ...
  <title>STOCK MAINTENANCE - SALES | TLS</title>
...
-->
           <li class="nav-item has treeview menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="SALES-SR.php" class="nav-link active">
...
//        
//    
    $query = "SELECT * FROM `sale_product` INNER JOIN `sale_entry` ON sale_product.bill_number = sale_entry.bill_number  ";
////        BETWEEN WHERE `bill_date` BETWEEN '{$from}' AND '{$to}'
//    
  $result = mysqli_query($connection, $query);

  while($row = mysqli_fetch_assoc($result)){
    $product_purchase_id = $row['sale_product_id'];
