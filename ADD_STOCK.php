       ...
       <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            <a href="ADD_STOCK.php" class="nav-link active">
          ...
          <div class="card-body">
              <div class="row" style="text-align: center">
                    <div class="col-lg-6" id="SUPPLIER">
                        ...
                        <input type="text" name="product" class="input"><br><br>
                   
                        <span>COMPANY:</span><br>
                        <input type="name" name="company" class="input"><br><br>
                   
                        <span>BRAND:</span><br>
                        <input type="name" name="brand" class="input"><br><br>
                        <span>UNITS:</span><br>
                        <input type="text" name="unit" class="input"><br><br>
                    </div>
                    ...
                    <div class='col-lg-6 '>
                        ...
                        <span>GST:</span><br>
                         <select class="btn btn-primary" name="gst_type">
                      <?php
                        echo "<option selected value='gst'>GST</option>"; 
                        echo "<option value='nongst'>NON - GST</option>";
                      ?>
                        
                    </select><br>
            
                        <span>SALES RATE:</span><br>
                        <input type="text" name="sales_rate" class="input"><br><br>
                    
                        <span>MRP:</span><br>
                        <input type="number" name="mrp" class="input"><br><br>
                   
                        <span>PURCHASE RATE:</span><br>
                        <input type="number" name="purchase_rate" class="input"><br><br>
                    </div>
                </div>
  
              <div style="text-align: center">
                  <button type="submit" class="btn col-lg-2 btn-primary" name="product_submit">Submit</button>
              </div>
...
//          echo "yessssssssssssssssssssssssssssssssss";
           ...
           $brand = $_POST['brand'];
           $unit = $_POST['unit'];
           echo $gst = $_POST['gst_type'];
           $sales_rate = $_POST['sales_rate'];
           $purchase_rate = $_POST['purchase_rate'];
           $mrp = $_POST['mrp'];

          
$query = "INSERT INTO `product` (`product_name`, `product_company`, `product_brand`, `product_unit`, `product_gst`, `product_sales_rate`, `product_mrp`, `product_purchase_rate`) VALUES ('$product', '$company', '$brand', $unit, '$gst', $sales_rate, $mrp, $purchase_rate) ";
